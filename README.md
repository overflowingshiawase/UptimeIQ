...
**Demo網址**：`（https://uptimeiq-demo.netlify.app/）`
...
本專案初期規劃範圍較大（涵蓋Dashboard、AI、多主題BRD等十餘項功能），經指導老師與業界PM審視後，重新定位為「產品導向」而非「案例導向」，將範圍收斂至2個核心模組並深化其邏輯完整度，而非追求功能廣度。此取捨過程本身即為本專案希望呈現的商業分析與範圍管理能力之一。
